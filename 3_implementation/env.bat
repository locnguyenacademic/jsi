...
set CLASSPATH=./hudup-core.jar;./hudup.jar;./sim.jar;./jsi.jar;./hudup-runtime-lib.jar;./sim-runtime-lib.jar;./jsi-runtime-lib.jar;./bin;./lib/*;./working/lib/*;%EXTRA_CLASSPATH%
